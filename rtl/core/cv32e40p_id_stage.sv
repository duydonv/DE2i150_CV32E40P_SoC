...
// The second package is re-imported inside the module body just below ");".
...
#(
  ...
  generate
    if (APU == 1) begin : gen_apu
      ...
      // Quartus Lite does not accept `for (genvar i = ...)` (SV-2012 inline genvar).
      // Since APU=0 here, we just tie the whole packed array to 0.
