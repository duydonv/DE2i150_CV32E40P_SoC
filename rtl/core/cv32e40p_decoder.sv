...
// Quartus Lite / SV-2005 does not accept multiple module-header imports.
// Extras are re-imported inside the module body just below ");".
    ...
    unique case (instr_rdata_i[6:0])
        ...
        // PREFIX 10
          ...
          ///////////////////////
            ...
            if (FPU == 1 && C_XFVEC == 1) begin
              ...
              casez (instr_rdata_i[29:25]) // Quartus Lite: `case () inside` -> casez
                ...
                5'b01100: begin
                  ...
                  casez (instr_rdata_i[24:20]) // Quartus Lite
              ...
              // check rounding mode
              if (check_fprm) begin
                casez (frm_i) // Quartus Lite: `case () inside`/range-label -> casez
      ...
      OPCODE_OP_FP: begin
        if (FPU == 1 && (ZFINX == 1 || fs_off_i == 1'b0)) begin
          ...
          unique case (instr_rdata_i[31:27])
            ...
            5'b00100: begin
              ...
              if (C_XF16ALT) begin  // FP16ALT instructions encoded in rm separately (static)
                // Quartus Lite: rewrite `inside {ranges}` -> explicit comparisons
                if (!((instr_rdata_i[14:12] <= 3'b010) ||
                      (instr_rdata_i[14:12] >= 3'b100 && instr_rdata_i[14:12] <= 3'b110))) begin
                  illegal_insn_o = 1'b1;
                end
          ...
          // check rounding mode
          if (check_fprm) begin
            casez (instr_rdata_i[14:12]) // Quartus Lite
              3'b000, 3'b001, 3'b010, 3'b011, 3'b100: ; //legal rounding modes
              3'b101: begin      // Alternative Half-Precsision encded as fmt=10 and rm=101
                if (~C_XF16ALT || fpu_dst_fmt_o != cv32e40p_fpu_pkg::FP16ALT) illegal_insn_o = 1'b1;
                // actual rounding mode from frm csr
                casez (frm_i) // Quartus Lite
